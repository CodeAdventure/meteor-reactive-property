(function () {
  ...
  Class('ReactiveProperty', {
    ...
    get: function() {
      ...
      if(this._isDestroyed) throw new Error('Cannot get the value of a destroyed reactive property.');
    ...
    set: function(value) {
      ...
      if(this._isDestroyed) throw new Error('Cannot set the value of a destroyed reactive property.');
    ...
    /**
     * Sets the value and dependency to null (clean up)
     *
     * @returns {undefined}
     * @memberof ReactiveProperty#
     */
